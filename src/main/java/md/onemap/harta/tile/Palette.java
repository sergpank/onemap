...
public class Palette
{
  ...
  public static final Color PEDESTRIAN_HIGHWAY_COLOR = new Color(192, 164, 164);
  public static final Color PEDESTRIAN_HIGHWAY_BORDER_COLOR = new Color(192, 128, 128);
  ...
  public static final Color BUILDING_FONT_COLOR = new Color(0, 0, 0);
  public static final int BUILDING_FONT_SIZE = 24;
  public static final String BUILDING_FONT_NAME = "Arial";
